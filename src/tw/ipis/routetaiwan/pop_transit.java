...
public class pop_transit extends Activity {
	...
	private void bus_agency_classify() {
		/* 台北公車 客運業者列表 */
		bus_taipei.add(new bus_provider("大都會客運",  null));
		bus_taipei.add(new bus_provider("三重客運", null));
		bus_taipei.add(new bus_provider("首都客運", null));
		bus_taipei.add(new bus_provider("指南客運", null));
		bus_taipei.add(new bus_provider("光華巴士", null));
		bus_taipei.add(new bus_provider("新店客運", null));
		bus_taipei.add(new bus_provider("中興巴士", null));
